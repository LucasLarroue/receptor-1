...
　
MOV		speed_motor_1, data			; Defino la velocidad del motor 1.
MOV		speed_motor_2, data				; Defino la velocidad del motor 2.
...
　
USART_RECEIVE:
; Si el flag RXC0 (ubicado en UCSR0A) esta en estado alto, entonces datos no leidos en el buffer. 
LDS		temp0, UCSR0A
SBRS	temp0, RXC0
RJMP	USART_RECEIVE

; Por lo tanto cuando esto sucede estamos en codiciones de tomar el dato del buffer.
LDS		data, UDR0
RET
